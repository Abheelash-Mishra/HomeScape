...
const RentModal = () => {
	...
	let bodyContent = (
		<div className={ "flex flex-col gap-8" }>
			<Heading
				title={ "Which one best describes your property?" }
	...
	if (step === STEPS.DESCRIPTION) {
		bodyContent = (
			<div className={ "flex flex-col gap-8" }>
				<Heading
					title={ "Talk a bit about your place!" }
					subtitle={ "Keep it short and sweet :)" }
				/>
				<Input
					id={ "title" }
					label={ "Give a name to your place..." }
					disabled={ isLoading }
					register={ register }
					errors={ errors }
					required
		...
		bodyContent = (
			<div className={"flex flex-col gap-8"}>
				<Heading
					...
					subtitle={"Set a price for your property per night"}
				/>
				<Input
					id={"price"}
					label={"Price"}
